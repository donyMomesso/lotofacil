...
_Atualizado em 03/07/2026 15:00 (horário de Brasília)_
...
- Total de concursos no histórico: 3725
- Concurso mais recente: 3725 (02/07/2026)
...
- Concurso: 3725
- Data: 02/07/2026
- Dezenas: 01-02-04-05-06-08-11-13-14-16-17-19-21-24-25
- Soma: 186
- Pares: 7 / Ímpares: 8
...
|---|---|---|---|---|---|
| M1_aleatorio_puro | 0 | 0.0 | 0.0 | 0.0% | 0.0% |
| M2_mais_frequentes | 0 | 0.0 | 0.0 | 0.0% | 0.0% |
| M3_mais_atrasadas | 0 | 0.0 | 0.0 | 0.0% | 0.0% |
| M4_par_impar_balanceado | 0 | 0.0 | 0.0 | 0.0% | 0.0% |
| M5_soma_faixa_comum | 0 | 0.0 | 0.0 | 0.0% | 0.0% |

## Conclusão educativa

Frequência e atraso mostram apenas o que já aconteceu na amostra observada — não indicam o que vai sair no próximo concurso. Cada sorteio é independente dos anteriores. Se, com o tempo, os métodos acima convergirem para uma média de acertos parecida com a esperança teórica, isso confirma que a Lotofácil se comporta como um sorteio aleatório, não que algum método é melhor para ganhar.
